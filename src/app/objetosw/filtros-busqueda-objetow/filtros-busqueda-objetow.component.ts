...
@Component({
  selector: 'ibpm-filtros-busqueda-objetow',
  imports: [FormsModule],
  templateUrl: './filtros-busqueda-objetow.component.html',
  styleUrl: './filtros-busqueda-objetow.component.scss',
})
export class FiltrosBusquedaObjetowComponent {
