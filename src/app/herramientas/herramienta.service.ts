...
export class HerramientaService {
   ...
   * @returns 
   */
  public createHerramienta(herramienta: HerramientaEntity): Observable<FsResponseEntity<any>> {
...
/**
  ...
  /**
     ...
     * @returns 
     */
    public editHerramienta(herramienta: HerramientaEntity): Observable<FsResponseEntity<any>> {
        let ip: string = this.cookieService.get('ip');
   ...
   * @returns 
   */
  public getHerramienta(workflowName: string, ToolName: string): Observable<FsResponseEntity<any>> {
      let ip: string = this.cookieService.get('ip');
      return this.http.get<FsResponseEntity<any>>(
        environment.workflowApiUrl +
