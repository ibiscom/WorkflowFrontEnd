...
export class CrearEntidadComponent {
  public uc?: EntidadComponent;
  public loggedUser?: LoginEntity;
  public nameN: string = '';
  public descriptionN: string = '';
  public entidadN: string = '';
  public entidadObjectN?: EntidadesEntity;
  ...
  public constructor(
    ...
    this.uc = this.entidadComponentInstanceService.getInstance();
  }
  ...
  public editMode(): boolean {
    return this.entidadIdEdit !== undefined && this.entidadIdEdit !== '';
  }

  /**
   * Maneja el cambio de compañía seleccionada.
   */
  public onEntidadChange(event: MatSelectChange<EntidadesEntity>) {
    this.entidadObjectN = event.value;
    this.entidadN = event.value?.nombre ?? '';
  }
   ...
   */
  public compareCompanies(c1: EntidadesEntity, c2: EntidadesEntity): boolean {
