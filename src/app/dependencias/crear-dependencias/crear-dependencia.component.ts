...
import { DependenciaEntity } from '../dependencias.entity';
...
export class CrearDependenciaComponent {
  ...
  public dependenciasObjectN?: DependenciaEntity;
   ...
   */
  public onDependenciaChange(event: MatSelectChange<DependenciaEntity>) {
    this.dependenciasObjectN = event.value;
    this.dependenciasN = event.value?.nombre ?? '';
  }
   ...
   */
  public compareCompanies(c1: DependenciaEntity, c2: DependenciaEntity): boolean {
