...
@Component({
  selector: 'ibpm-crear-responsable',
  imports: [
    FormsModule,
    MatCardModule,
    MatInputModule,
  ...
  styleUrl: './crear-responsable.component.scss',
})
/**
...
export class CrearResponsableComponent {
  ...
  public constructor(
    ...
    this.uc = this.responsableComponentInstanceService.getInstance();
  }
  ...
  public editMode(): boolean {
    return this.responsableIdEdit !== undefined && this.responsableIdEdit !== '';
  }

  /**
   * Maneja el cambio de compañía seleccionada.
   */
  public onResponsableChange(event: MatSelectChange<ResponsableEntity>) {
    this.responsableObjectN = event.value;
    this.responsableN = event.value?.nombre ?? '';
  }
   ...
   */
  public compareCompanies(c1: ResponsableEntity, c2: ResponsableEntity): boolean {
